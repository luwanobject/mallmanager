...
spu商品信息管理
<hr>
一级：<select id="class_1_select" onchange="get_class_2(this.value);">
    <option>请选择</option>
</select>
...
<script type="">
    ...
    function goto_spu_add(){
        ...
        window.location.href="goto_spu_add.do?flbh1="+class_1_id+"&flbh2="+class_2_id+"&ppId="+tm_id;
    }
</script>
</body>
</html>
