...
spu商品信息管理
<hr>
一级：<select id="attr_class_1_select" onchange="get_attr_class_2(this.value);">
    <option>请选择</option>
</select>
二级：<select id="attr_class_2_select" onchange="get_attr_list_json(this.value)">
    <option>请选择</option>
</select>
<br>
查询<br>
...
//            window.location.href="goto_attr_add.do?flbh2="+class_2_id;
    ...
    function get_attr_list(flhb2) {
        console.log(flhb2)
        //异步查询
        $.post("get_attr_list.do",{flhb2:flhb2},function (data) {
    ...
    function get_attr_list_json(flbh2){
        ...
        $('#attrListInner').datagrid({
            ...
            columns:[[
                ...
                {field:'listvalue',title:'属性值',width:300,
